              ...
              <div class="swiper-container mainbans">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="/assets/images/front_images/SME-banner.jpg">
                  </div>
                  <div class="swiper-slide">
                    <img src="/assets/images/front_images/Ecofriendly-banner.jpg">
                  </div>
                  <div class="swiper-slide">
                    <img src="/assets/images/front_images/Ecofriendly-banner.jpg">
                  </div>
                ...
                <div class="block-products-carousel__cell">
                  ...
                  <div class="product-card product-card--hidden-actions">
                    <button class="product-card__quickview" type="button">
                      <a class="fa fa-eye" data-toggle="modal" data-target="#demoModal"></a>
                    </button>
                    ...
                    <div class="product-card__image product-image">
                      <a href="{{ url('product/'.$products->id) }}" class="product-image__body"><img class="product-image__img"
                          src="{{asset('assets/images/back_images/products/large/'.$products->image) }}" alt="" /></a>
                    </div>
                    ...
                    <div class="product-card__actions">
                      ...
                      <div class="product-card__buttons">
                        ...
                        <button href="cart.html" class="btn btn-light btn-svg-icon--fake-svg product-card__wishlist price-calculator-button"
        ...
        <div class="container">
          <a href="#" class="block-banner__body">
            <div class="block-banner__image block-banner__image--desktop"
              style="background-image: url('/assets/images/front_images/idesign/index-mid-banner.png')"></div>
            <div class="block-banner__image block-banner__image--mobile"
              style="background-image: url('/assets/images/front_images/banners/banner-1-mobile.jpg')"></div>
              ...
              <div class="block-products-carousel__column">
                <div class="block-products-carousel__cell">
                  <div class="product-card product-card--hidden-actions">
                    ...
                    <div class="product-card__image product-image">
                      <a href="product.html" class="product-image__body"><img class="product-image__img"
                          src="https://img.freepik.com/free-vector/elegant-minimal-black-yellow-business-card-template_1017-22513.jpg?size=338&ext=jpg" alt="" /></a>
                    </div>
                    <div class="product-card__info">
                      <div class="product-card__name">
                        <a href="product.html">Visting card</a>
                      </div>
                      <div class="product-card__rating">
                        <div class="product-card__rating-stars">
                          <div class="rating">
              ...
              <div class="block-products-carousel__column">
                <div class="block-products-carousel__cell">
                  <div class="product-card product-card--hidden-actions">
                    ...
                    <div class="product-card__image product-image">
                      <a href="product.html" class="product-image__body"><img class="product-image__img"
                          src="https://files.inkmonk.com/site/20181116_152415469690_c46642_20180710_020648373143_752d14_Visiting_card_new.png" alt="" /></a>
                    </div>
                    <div class="product-card__info">
                      <div class="product-card__name">
                        <a href="product.html">Custom cards</a>
                      </div>
                      <div class="product-card__rating">
                        <div class="product-card__rating-stars">
                          <div class="rating">
              ...
              <div class="block-products-carousel__column">
                <div class="block-products-carousel__cell">
                  <div class="product-card product-card--hidden-actions">
                    ...
                    <div class="product-card__image product-image">
                      <a href="product.html" class="product-image__body"><img class="product-image__img"
                          src="https://www.circleone.in/images/products_gallery_images/Circle-One_Business_CardsWeb_5_1.jpg" alt="" /></a>
                    </div>
                    <div class="product-card__info">
                      <div class="product-card__name">
                        <a href="product.html">Custom cards</a>
      ...
      <div class="twoad">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                     <a href="#" class="block-banner__body">
                        <img src="https://cdn.sastodeal.com/salesbanner_salesbanner/m/i/microsoftteams-image_76_.png">
                  ...
                  <div class="col-lg-6">
                     <a href="#" class="block-banner__body">
          <img src="https://cdn.sastodeal.com/salesbanner_salesbanner/m/i/microsoftteams-image_21_.png">
